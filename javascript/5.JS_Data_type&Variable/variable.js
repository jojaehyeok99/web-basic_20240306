...
var varVariable;
let letVariable;
const constVariable =10; //const : 자바스크립트에서 상수를 의미하며, 반드시 초기화 후 사용
...
/*
  var 키워드로 선언한 변수는 블랙 레벨 스코프가 아닌 함수 레벨 스코프를 가짐
  - 함수 레벨 스코프 : 함수 내에서 선언된 변수는 함수 안에서 사용 가능, 함수 밖에선 사용 불가능
  - 블록 레벨 스코프 : 코드 블럭 내에서 선언된 변수는 코드 블럭 안에서 사용 가능, 코드 블럭 밖에서 사용 불가능
*/
...
// console.log(y); //선언하기 전에 초기화 할 수 없음
let y = 10;
if (true) {
  let y = 99;
}
