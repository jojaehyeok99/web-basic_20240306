...
/*
  - javascript의 문자열은 배열처럼 인덱스를 이용해서 접근할 수 있음(유사 배열 또는 반복 가능 객체) 
*/
...
var obj={};
console.log(obj.age); // 자바스크립트는 컴파일 언어가 아니라서 오류가 안남

/*
  null : 의도적으로 변수에 값이 없다는 것을 명시하는 타입
  - 변수에 저장된 메모리 주소를 제거하는 용도 
  - 함수의 반환값으로 유효한 값이 없을 때 반환하는 용도
  - null 값은 typeof(타입확인 연산자)로 확인하면 object 타입이 반환됨(단순 자바스크립트 자체의 문제) 
*/
