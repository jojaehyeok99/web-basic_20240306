...
/*
	...
	- <= : 좌항이 우항보다 작거나 같다
*/
// console.log(10 > '9'); //숫자타입과 문자타입 비교 가능
// console.log(10 > '99');
...
/*
	쉼표 연산자 : 왼쪽 피 연산자부터 차례로 피 연산자를 연산
*/
let x,y,z;
x = 10, y = 20, z = 30;
...
*/
let type = typeof x;
console.log(type); // x의 변수 타입
console.log(typeof type); // type의 데이터 타입
