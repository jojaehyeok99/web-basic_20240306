...
/*
  ...
  - 배열[인덱스]로 요소에 접근 가능, (단, 존재하지 않는 요소에 접근하면 undefined 반환)
...
/*
  - for-in 순회 방식은 index를 사용하여 한번 더 작업 해야 하기 때문에
...
*/
console.log(fruits, fruits.length); // 배열의 요소와 길이 반환
console.log(fruits.push('orange')); // 요소를 추가후 배열의 길이를 반환
console.log(fruits); // 추가된 배열의 요소 반환
console.log('==============================');
...
*/
console.log(fruits.pop()); // 제거한 마지막 요소 반환
console.log(fruits); // 제거된 배열의 요소 반환
...
*/
console.log(fruits.shift()); // 제거한 첫번째 요소 반환
console.log(fruits); // 제거된 배열의 요소 반환
